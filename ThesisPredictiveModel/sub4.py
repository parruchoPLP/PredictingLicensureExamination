...
selected_columns = grade_columns + ['SUB4']
...
model_file_path = "category_4_model.pkl"
full_model_path = os.path.join(os.getcwd(), model_file_path)

try:
    joblib.dump(model, full_model_path)
    print("Model saved successfully as 'category_4_model.pkl'")
