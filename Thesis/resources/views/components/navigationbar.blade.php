...
<button id="navbar-toggle" class="fixed top-4 left-4 z-50 py-3 px-4 text-2xl text-slate-600 bg-white dark:bg-slate-900 dark:text-slate-200 shadow-lg rounded hover:bg-slate-200 hover:dark:bg-slate-600" type="button" data-drawer-target="navbar" data-drawer-show="navbar" aria-controls="navbar">
    <i class="fa fa-bars"></i>
</button>

<button id="darkmode-toggle" class="fixed bottom-4 right-4 z-20 py-3 px-4 text-2xl text-slate-600 bg-white dark:bg-slate-900 dark:text-slate-200 shadow-lg rounded hover:bg-slate-200 hover:dark:bg-slate-600">
...
<nav id="navbar" class="fixed top-0 left-0 h-full shadow-xl w-auto bg-white dark:bg-slate-900 flex flex-col items-center font-arial text-lg z-50 transform -translate-x-full transition-transform duration-300 ease-in-out" tabindex="-1" aria-labelledby="navbar-label">
    ...
    <ul class="pt-24 px-4">
        ...
        <li>
            <a href="/filemanagement" class="block py-6 px-14 rounded-lg text-slate-800 dark:text-slate-200 hover:text-emerald-500 dark:hover:text-emerald-300 hover:font-bold {{ request()->is('filemanagement') ? 'bg-slate-300 font-bold dark:bg-gray-700' : '' }}">
