...
<section id="dashboard" class="bg-slate-100 text-slate-900 dark:bg-slate-800 dark:text-slate-200 min-h-screen pr-9 pl-36 py-24 space-y-12 font-arial">
    ...
    <div class="grid grid-cols-1 md:grid-cols-7 gap-4">
        <div class="bg-white dark:bg-slate-700 p-10 rounded-xl shadow-md md:col-span-2 transition-transform transform hover:scale-105">
        ...
        <div class="bg-white p-10 dark:bg-slate-700 rounded-xl shadow-md flex flex-col md:col-span-2 overflow-auto transition-transform transform hover:scale-105">
            <h2 class="text-2xl font-bold">Top 3 Licensure Outcome Predictors</h2>
            <ul id="topPredictorsList" class="text-2xl mt-10 space-y-2">
            </ul>
        </div>
        <div class="bg-white dark:bg-slate-700 p-8 rounded-xl shadow-md max-h-[400px] relative overflow-auto md:col-span-3 transition-transform transform hover:scale-105">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div class="bg-white dark:bg-slate-700 p-10 rounded-xl shadow-md overflow-auto transition-transform transform hover:scale-105">
