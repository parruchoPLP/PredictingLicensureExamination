...
<section id="report" class="bg-slate-100 dark:bg-slate-800 min-h-screen pr-9 pl-36 py-36 font-arial">
    <div id="files" class="bg-white dark:bg-slate-700 rounded-xl shadow-lg p-8">
        ...
        @php
            $titles = [
                'Student ID', 'Age', 'Gender', 'Course Code',
            ];

            $file = [
                ['id' => '21-000001', 'age' => 21, 'gender' => 'M', 'courseCode' => '1.25',],
            ];
        ...
        <table class="min-w-full bg-white text-sm border border-collapse dark:bg-slate-800">
            ...
            <tbody class="text-gray-700 dark:text-slate-200">
                ...
                <tr class="border-b">
                    ...
                    <td class="py-2 px-4 whitespace-nowrap">{{ $row['age'] }} <i class="fa fa-question-circle text-xs hover:text-emerald-400 dark:hover:text-emerald-600" data-popover-target="popAge"> </i> @include('components.popover', ['id' => 'popAge'])</td>
                    <td class="py-2 px-4 whitespace-nowrap">{{ $row['gender'] }} <i class="fa fa-question-circle text-xs hover:text-emerald-400 dark:hover:text-emerald-600" data-popover-target="popGender"> </i> @include('components.popover', ['id' => 'popGender'])</td>
